...
class Viewer360 extends StatefulWidget {
  final String tempPath;

  Viewer360({Key? key, required this.tempPath}) : super(key: key);

  @override
  _Viewer360State createState() => _Viewer360State();
}

class _Viewer360State extends State<Viewer360> {
  double _lon = 0;
  double _lat = 0;
  double _tilt = 0;
  int _panoId = 0;
  ...
  void initState() {
    ...
    panoImages = [
      Image.file(File(widget.tempPath)),
      Image.asset('assets/panorama2.webp'),
      Image.asset('assets/panorama_cropped.webp'),
    ];
  }
    ...
    switch (_panoId % panoImages.length) {
      case 0:
        panorama = Panorama(
          ...
          child: Image.file(File(widget.tempPath)),
          /*hotspots: [
            Hotspot(
              latitude: -15.0,
              longitude: -129.0,
